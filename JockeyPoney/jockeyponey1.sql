...
DROP DATABASE IF EXISTS jockeyponey1;
CREATE DATABASE jockeyponey1;
...
CREATE TABLE jockeyponeycourse(
        ...
        PRIMARY KEY (id),
        UNIQUE(id_jockey,id_course),
        UNIQUE(id_poney,id_course)
)ENGINE=InnoDB;

ALTER TABLE jockeyponeycourse ADD CONSTRAINT FK_jockeyponeycourse_id_jockey FOREIGN KEY (id_jockey) REFERENCES jockey(id);
ALTER TABLE jockeyponeycourse ADD CONSTRAINT FK_jockeyponeycourse_id_poney FOREIGN KEY (id_poney) REFERENCES poney(id);
ALTER TABLE jockeyponeycourse ADD CONSTRAINT FK_jockeyponeycourse_id_course FOREIGN KEY (id_course) REFERENCES course(id);
